            ...
            <Tr>
              <Th>
                <Flex 
                 ...
                 cursor='pointer'
                 alignItems='center'> Task{searchParams.get('orderBy') 
                 === 'name' && <BsArrowUp/>}
                 </Flex>
                 </Th>
              <Th>
                <Flex 
                 ...
                 cursor='pointer'
                 alignItems='center'> Priority{searchParams.get('orderBy') 
                 === 'priority' && <BsArrowUp/>}
                 </Flex>
                 </Th>
              <Th>
              <Flex 
                 ...
                 cursor='pointer'
                 alignItems='center'> Status{searchParams.get('orderBy') 
                 === 'status' && <BsArrowUp/>}
                 </Flex>
                 </Th>
              <Th><Flex 
                 ...
                 cursor='pointer'
                 alignItems='center'> Due Date{searchParams.get('orderBy') 
                 === 'due' && <BsArrowUp/>}
                 </Flex></Th>
            </Tr>
          </Thead>
